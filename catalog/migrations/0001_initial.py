    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True)),
                ('hex_code', models.CharField(help_text='Hex-код кольору (наприклад, #FF5733)', max_length=7, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('colors', models.ManyToManyField(related_name='products', to='catalog.color')),
            ],
        ),
    ]
